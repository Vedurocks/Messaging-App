...
-- ------------------------------------------------------------
-- Migration-safe additions for databases that already ran an
-- earlier version of this schema (CREATE TABLE IF NOT EXISTS is a
-- no-op on existing tables, so new columns need an explicit ALTER).
