...
export async function GET(request: NextRequest) {
  try {
    ...
    const result = await sql`
      SELECT id, username, email, display_name, avatar_url, status, last_seen, created_at, updated_at, is_active
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    const result = await sql`
      ...
      RETURNING id, username, email, display_name, avatar_url, status, last_seen, created_at, updated_at, is_active
    `;
